...
describe('aztec node', () => {
  ...
  describe('getters', () => {
    ...
    describe('getBlockHeader', () => {
      ...
      beforeEach(() => {
        initialHeader = BlockHeader.empty({ globalVariables: GlobalVariables.empty({ blockNumber: BlockNumber(0) }) });
        header1 = BlockHeader.empty({ globalVariables: GlobalVariables.empty({ blockNumber: BlockNumber(1) }) });
