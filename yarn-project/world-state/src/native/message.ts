...
export function buildEmptyTreeMeta() {
  return {
    ...
    size: 0n,
    committedSize: 0n,
    unfinalizedBlockHeight: BlockNumber(0),
    finalizedBlockHeight: BlockNumber(0),
    oldestHistoricBlock: BlockNumber(0),
    root: Fr.ZERO,
    initialRoot: Fr.ZERO,
    initialSize: 0n,
  } as TreeMeta;
...
export function buildEmptyWorldStateSummary() {
  return {
    unfinalizedBlockNumber: BlockNumber(0),
    finalizedBlockNumber: BlockNumber(0),
    oldestHistoricalBlock: BlockNumber(0),
